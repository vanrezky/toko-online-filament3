                    ...
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ($product->images as $image)
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ getUrlImage($image) }}'">
                                    <img src="{{ getUrlImage($image) }}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                @if ($product->sale_price)
                                    <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ $product->sale_price_currency }}</span>
                                @endif
                            </p>
                            <p class="max-w-md text-gray-700 dark:text-gray-400">{!! $product->description !!}
                            </p>
                        </div>
                        <div class="w-32 mb-8 ">
