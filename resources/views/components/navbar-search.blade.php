...
<div class="relative w-full">
    <input type="text" class="w-full text-sm font-light peer py-3 px-4 ps-11 {{ $claseses }} bg-background3 border-transparent rounded-md disabled:opacity-50 disabled:pointer-events-none form-primary"
