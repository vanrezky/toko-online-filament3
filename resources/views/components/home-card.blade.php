...
<div class="container-content">
    ...
    @else
        <div class="flex items-center justify-between py-2">
            <div class="text-2xl font-semibold sm:text-[30px] tracking-wide">{{ $subtitle }}</div>
            <a href="{{ $link }}" class="rounded-lg  px-3 py-2  md:px-5 md:py-3 text-xs  btn-general ">View All</a>
        </div>
    @endif
